const ButtonSvg = (white) => (
  <>
    ...
    >
      <path
        fill={white ? "#2563EB" : "none"}
        stroke={white ? "#2563EB" : "url(#btn-left)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      <path
        fill={white ? "#2563EB" : "none"}
        stroke={white ? "#2563EB" : "url(#btn-right)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
